...
public class VocabularyActivity2 extends AppCompatActivity  {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new SpellingQues("Always be _____ in life.", "Positive", "Pozitiv", 1));
        questionList.add(new SpellingQues("The whale was __ ", "Jijantic", "Gigantic", 2));
        questionList.add(new SpellingQues("Diamonds are the most hardest and ____", "Precious", "Presiuous", 1));
        questionList.add(new SpellingQues("Teacher writes on ___ in school", "board", "bored", 1));
        ...
        questionList.add(new SpellingQues("Indian __ has 3 colours.", "flague", "flag", 2));
    ...
    private void changeQuestion() {
        if(quesNum < questionList.size()-1){
            ...
            Intent intent = new Intent(VocabularyActivity2.this,Vocabulary_Score.class);
