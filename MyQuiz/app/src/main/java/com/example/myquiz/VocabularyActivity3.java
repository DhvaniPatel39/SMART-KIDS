...
public class VocabularyActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getQuestionsList() {
        ...
        questionList.add(new VerbQues("Soes she ________ anything about this?","A. knew","B. knows","C. know",3));
    ...
    private void changeQuestion() {
        if(quesNum < questionList.size()-1){
            ...
            Intent intent = new Intent(VocabularyActivity3.this,ScoreActivity.class);
